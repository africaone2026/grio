    ...
    <div className="p-8">
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm text-center">
          <p className="text-4xl font-bold text-gray-900">{userProgress.overallPercentage}%</p>
          <p className="text-sm text-gray-500 mt-1">Overall Completion</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm text-center">
          <p className="text-4xl font-bold text-gray-900">{userProgress.completedLessons}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Subjects Started</p>
        </div>
      </div>

      <div className="grid lg:grid-cols-2 gap-8 mb-8">
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <h2 className="font-bold text-gray-900 mb-5">Progress by Subject</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <h2 className="font-bold text-gray-900 mb-5">Completion Map</h2>
            ...
            {userProgress.recentActivity.map((activity) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-800">{activity.lessonTitle}</p>
